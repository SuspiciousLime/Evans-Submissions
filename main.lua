...
function love.load()
    ...
    player1 = Paddle(30, 10, 5, 20)
    player2 = Paddle(VIRTUAL_WIDTH - 30, VIRTUAL_HEIGHT - 10, 5, 20)
...
function love.draw()
    ...
    if gameState == 'start' then
        -- UI messages
        love.graphics.setFont(smallFont)
        love.graphics.printf('Welcome to Pong by Evan!', 0, 20, VIRTUAL_WIDTH, 'center')
...
function displayFPS()
    ...
    love.graphics.print('FPS: ' .. tostring(love.timer.getFPS()), 10, VIRTUAL_HEIGHT / 2 - 5)
...
function displayHits()
    ...
    love.graphics.print('Hits: ' .. tostring(hits), 10, VIRTUAL_HEIGHT / 2 + 5)
    love.graphics.setColor(255, 255, 255, 255)
end